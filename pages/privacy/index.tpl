...
block content
  ...
  p Our Privacy Policy has been developed as an extension of our commitment to combine quality products and services with integrity in dealing with users. The Policy is designed to assist you in the understanding of how we collect, use and protect the personal information provided to us.

  h2 What Information Do We Collect?

  p When you visit our site, we collect two types of information: personal information you actively choose to disclose (“Active Information”) and use information collected, in a way not visible to you, on an aggregate anonymous basis as you and other users browse our site (“Passive Information”).

  h2 Personally Identifiable Information

  p This refers to information that lets us know specifically about you i.e. profile information.
  ...
  p When you place an order for products or services, we collect Personally Identifiable Information (such as name, contact and billing information, credit card, and other transactional information). We use this information to deliver your order, process payment, and to communicate the status of your order.

  h3 Credit Card Storage

  p Credit card information collected at registration or for product orders is used only to process payment for the transaction and, generally, is not retained on our Site. However, you may voluntarily elect to securely store multiple credit cards to be used for product orders.

  p Surveys and Promotions

  p Occasionally, you may voluntarily provide Personally Identifiable Information to complete surveys and questionnaires or to participate in user polls. We use this information to improve our products and services and to ensure that we’re providing accurate disclosures. We may also use your Personally Identifiable Information to provide you newsletters and other marketing information that coincide with your preferences. You may customize your marketing preferences, or let us know if you do not wish to receive any promotional materials, by adjusting your Subscriptions &amp; Email options on the Site.
  ...
  h2 Active Information You Choose to Provide
  ...
  h2 Passive Information Collected
  ...
  h2 How Do We Use the Information Collected?
  ...
  h2 Your Information In Relation to Others We Link To

  p You might be able to access other websites through our site via hyperlinks. When you do so, you are subjecting yourself to their privacy policies and data collection. Please read the privacy policies of those sites to ensure you agree with the terms before using such sites.

  h2 Sharing Information with Advertisers or Other Third Parties

  p We may disclose anonymous information about user habits to advertisers on our site. The parties who perform services for us (credit card processors, merchant bank, Internet Service Provider) may also have access to your information in performing such services. Should we buy or sell assets of our company, another company may need to review our company’s assets, which might include your information, to make business decisions as to whether to acquire such assets.

  h2 Sharing Information with the Government or As Otherwise Required by Law

  p We may be required by subpoena, law or government agency to disclose both Active and Passive Information you have provided to us.

  h2 How Do We Secure Active Information and Passive Information?
  ...
  p Children’s Privacy Protection We take special care to protect the privacy needs of children and encourage parents to be an active participant in their child’s online activities. Our Site does not target and is not intended for children under the age of 18, and we will not knowingly collect Personally Identifiable Information from them. If we discover personal data from a child through our site, we will eliminate that data. You may learn more about protecting children’s privacy online by visiting: http://www.ftc.gov/bcp/edu/pubs/consumer/tech/tec08.shtm.

  p Changes to This Statement Any updates or changes to the terms of this Privacy Statement will be posted on our Site and the date of the newest version posted below. Please check back frequently, especially before you submit any Personally Identifiable Information at our Site, to see if this Privacy Statement has changed. By using our Site, you acknowledge acceptance of this Privacy Statement in effect at the time of use.

  p YOUR USE OF OUR SITE MEANS THAT YOU ACCEPT THE PRACTICES SET FORTH IN THIS POLICY. YOUR CONTINUED USE INDICATES YOUR AGREEMENT TO THE CHANGES.
